...
import AdressCompanyStep from "./formContactDataCompany/AdressCompanyStep"
import ContactCompanyStep from "./formLegalDataCompany/ContactCompanyStep"
import LegalCompanyStep from "./formBankDataCompany/LegalCompanyStep"
...
function Stepper({ currentStep }: StepperProps) {
    return (
        <ol className="flex items-center justify-between w-full">
            {[ClipboardMinus, Phone, Scale, Landmark].map((Icon, index) => {
                const step = index + 1;
                ...
                return (
                    <li
                        key={step}
                        className={`flex w-full items-center ${active ? "text-[#5fe0d5]" : "text-gray-500"} after:content-[''] after:w-full after:h-1 after:border-b after:border-4 after:inline-block ${active ? "after:border-[#5fe0d5]/30" : "after:border-gray-100 dark:after:border-gray-700"}`}
                    >
                        <span
